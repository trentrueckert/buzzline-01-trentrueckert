...
def process_message(log_file) -> None:
    ...
    with open(log_file, "r") as file:
        ...
        while True:
            ...
            if "I just stocked a dog toy! It was gnarly." in message:
                print(f"ALERT: I do this almost everyday! \n{message}")
                logger.warning(f"ALERT: I do this almost everyday! \n{message}")
