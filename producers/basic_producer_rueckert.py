...
ADJECTIVES: list = ["old", "gnarly", "broken", "cold", "slimy"]
ACTIONS: list = ["stocked", "unloaded", "straightened", "damaged out", "backstocked"]
TOPICS: list = ["a Lego set", "a bag of candy", "a vacuum", "a shovel", "a dog toy"]
